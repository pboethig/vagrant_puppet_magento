 ...
 */
/**
 * Page comments resource collection model
 *
 * @category    Ibrams
 * @package     Ibrams_CmsExtended
 * @author      Ultimate Module Creator
 */
class Ibrams_CmsExtended_Model_Resource_Page_Comment_Page_Collection extends Ibrams_CmsExtended_Model_Resource_Page_Collection
{
    /**
     * Entities alias
     *
    ...
    protected function _construct()
    {
        ...
        $this->_commentStoreTable = Mage::getSingleton('core/resource')
            ->getTableName('ibrams_cmsextended/page_comment_store');
    }
    ...
    {
        $this->getSelect()->where('ct.page_id = ?', $entityId);
        return $this;
    }
    ...
    protected function _joinFields()
    {
        $commentTable = Mage::getSingleton('core/resource')
            ->getTableName('ibrams_cmsextended/page_comment');
        $this->getSelect()->join(
            array('ct' => $commentTable),
            'ct.page_id = main_table.entity_id',
            array(
                'ct_title'      => 'title',
