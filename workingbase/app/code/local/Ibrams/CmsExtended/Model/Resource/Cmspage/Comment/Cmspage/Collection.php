 ...
 */
/**
 * Cmspage comments resource collection model
 *
 * @category    Ibrams
 * @package     Ibrams_CmsExtended
 * @author      Ultimate Module Creator
 */
class Ibrams_CmsExtended_Model_Resource_Cmspage_Comment_Cmspage_Collection extends Ibrams_CmsExtended_Model_Resource_Cmspage_Collection
{
    /**
     * Entities alias
     *
    ...
    protected function _construct()
    {
        ...
        $this->_commentStoreTable = Mage::getSingleton('core/resource')
            ->getTableName('ibrams_cmsextended/cmspage_comment_store');
    }
    ...
    {
        $this->getSelect()->where('ct.cmspage_id = ?', $entityId);
        return $this;
    }
    ...
    protected function _joinFields()
    {
        $commentTable = Mage::getSingleton('core/resource')
            ->getTableName('ibrams_cmsextended/cmspage_comment');
        $this->getSelect()->join(
            array('ct' => $commentTable),
            'ct.cmspage_id = main_table.entity_id',
            array(
                'ct_title'      => 'title',
