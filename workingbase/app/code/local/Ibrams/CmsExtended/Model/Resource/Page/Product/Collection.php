 ...
 */
/**
 * Page - product relation resource model collection
 *
 * @category    Ibrams
 * @package     Ibrams_CmsExtended
 * @author      Ultimate Module Creator
 */
class Ibrams_CmsExtended_Model_Resource_Page_Product_Collection extends Mage_Catalog_Model_Resource_Product_Collection
{
    /**
    ...
    public function joinFields()
    {
        if (!$this->_joinedFields) {
            $this->getSelect()->join(
                array('related' => $this->getTable('ibrams_cmsextended/page_product')),
