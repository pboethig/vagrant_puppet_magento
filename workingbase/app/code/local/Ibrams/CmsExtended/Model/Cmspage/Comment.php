 ...
 */
class Ibrams_CmsExtended_Model_Cmspage_Comment extends Mage_Core_Model_Abstract
{
     ...
     */
    const ENTITY    = 'ibrams_cmsextended_cmspage_comment';
    const CACHE_TAG = 'ibrams_cmsextended_cmspage_comment';
    /**
     * Prefix of model events names
     * @var string
     */
    protected $_eventPrefix = 'ibrams_cmsextended_cmspage_comment';
